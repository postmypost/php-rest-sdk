...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.postmypost.io/v4.1';
    ...
    {
        $report  = 'PHP SDK (Postmypost\RestSdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 4.1.3' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.postmypost.io/v4.1",
