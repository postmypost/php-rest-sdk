...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'login' => 'string',
        'connection_status' => '\Postmypost\RestSdk\Model\AccountConnectionStatusEnum'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chanel_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chanel_id'] === null) {
            $invalidProperties[] = "'chanel_id' can't be null";
        }
    ...
    {
        return $this->container['chanel_id'];
    }

    /**
     * Sets chanel_id
     *
     * @param int $chanel_id Channel ID
     *
     * @return self
     */
    public function setChanelId($chanel_id)
    {
        if (is_null($chanel_id)) {
            throw new \InvalidArgumentException('non-nullable chanel_id cannot be null');
        }
        $this->container['chanel_id'] = $chanel_id;
     ...
     * Sets external_id
     *
     * @param string $external_id Account ID in the channel
     *
     * @return self
     */
     ...
     * Sets login
     *
     * @param string|null $login Account login
     *
     * @return self
     */
     ...
     *
     * @return \Postmypost\RestSdk\Model\AccountConnectionStatusEnum
     */
     ...
     *
     * @param \Postmypost\RestSdk\Model\AccountConnectionStatusEnum $connection_status connection_status
     *
     * @return self
     */
