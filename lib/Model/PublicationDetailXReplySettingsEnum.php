...
/**
 * PublicationDetailXReplySettingsEnum Class Doc Comment
 *
 * @category Class
 * @description X reply settings: 1 — Everyone, 2 — Following, 3 — Mentioned users
 * @package  Postmypost\RestSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PublicationDetailXReplySettingsEnum
{
    /**
     * Possible values of this enum
     */
    public const NUMBER_EVERYONE = 1;

    public const NUMBER_FOLLOWING = 2;

    public const NUMBER_MENTIONED_USERS = 3;
    ...
    {
        return [
            self::NUMBER_EVERYONE,
            self::NUMBER_FOLLOWING,
            self::NUMBER_MENTIONED_USERS
        ];
    }
}
