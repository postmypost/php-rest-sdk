 ...
 *
 * @category Class
 * @description Media file (image or video) used as an attachment
 * @package  Postmypost\RestSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class MediaFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets width
     *
     * @param int|null $width File width in pixels
     *
     * @return self
     */
     ...
     * Sets height
     *
     * @param int|null $height File height in pixels
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url URL to download or view the file
     *
     * @return self
     */
