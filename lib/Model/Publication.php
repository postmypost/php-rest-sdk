 ...
 *
 * @category Class
 * @description Contains information about the publication, scheduled time, status, publication details, and the accounts where it is published
 * @package  Postmypost\RestSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Publication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'publication_status' => '\Postmypost\RestSdk\Model\PublicationStatusEnum'
    ];
    ...
    */
     ...
     *
     * @return \Postmypost\RestSdk\Model\PublicationStatusEnum
     */
     ...
     *
     * @param \Postmypost\RestSdk\Model\PublicationStatusEnum $publication_status publication_status
     *
     * @return self
     */
