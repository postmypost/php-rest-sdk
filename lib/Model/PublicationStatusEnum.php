...
class PublicationStatusEnum
{
     ...
     */
    public const NUMBER_DELETED = 0;

    public const NUMBER_PUBLISHED = 1;

    public const NUMBER_PUBLISHING = 2;

    public const NUMBER_ERROR = 3;

    public const NUMBER_DRAFT = 4;

    public const NUMBER_PENDING_PUBLICATION = 5;

    public const NUMBER_NOT_DELETED_DUE_TO_ERROR = 6;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::NUMBER_DELETED,
            self::NUMBER_PUBLISHED,
            self::NUMBER_PUBLISHING,
            self::NUMBER_ERROR,
            self::NUMBER_DRAFT,
            self::NUMBER_PENDING_PUBLICATION,
            self::NUMBER_NOT_DELETED_DUE_TO_ERROR,
