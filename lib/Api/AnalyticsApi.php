...
class AnalyticsApi
{
     ...
     * @param  \DateTime $date_from Start date of the period (YYYY-MM-DD) (required)
     * @param  \DateTime $date_to End date of the period (YYYY-MM-DD) (required)
     * @param  int|null $type Publication Type: 1 — post, 3 — story, 4 — reels/shorts (optional)
     ...
     */
    public function getAnalyticsPublications($project_id, $account_id, $date_from, $date_to, $type = null, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getAnalyticsPublications'][0])
    {
        list($response) = $this->getAnalyticsPublicationsWithHttpInfo($project_id, $account_id, $date_from, $date_to, $type, $sort, $page, $per_page, $contentType);
        return $response;
    }
     ...
     */
    public function getAnalyticsPublicationsWithHttpInfo($project_id, $account_id, $date_from, $date_to, $type = null, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getAnalyticsPublications'][0])
    {
        $request = $this->getAnalyticsPublicationsRequest($project_id, $account_id, $date_from, $date_to, $type, $sort, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAnalyticsPublicationsAsync($project_id, $account_id, $date_from, $date_to, $type = null, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getAnalyticsPublications'][0])
    {
        return $this->getAnalyticsPublicationsAsyncWithHttpInfo($project_id, $account_id, $date_from, $date_to, $type, $sort, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAnalyticsPublicationsAsyncWithHttpInfo($project_id, $account_id, $date_from, $date_to, $type = null, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getAnalyticsPublications'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsPublicationsRequest($project_id, $account_id, $date_from, $date_to, $type = null, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getAnalyticsPublications'][0])
    {
        ...
        if ($per_page !== null && $per_page > 50) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling AnalyticsApi.getAnalyticsPublications, must be smaller than or equal to 50.');
        }
