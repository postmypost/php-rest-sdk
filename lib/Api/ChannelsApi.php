...
class ChannelsApi
{
     ...
     */
    public function getChannels($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getChannels'][0])
    {
        list($response) = $this->getChannelsWithHttpInfo($sort, $page, $per_page, $contentType);
        return $response;
    }
     ...
     */
    public function getChannelsWithHttpInfo($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getChannels'][0])
    {
        $request = $this->getChannelsRequest($sort, $page, $per_page, $contentType);
     ...
     */
    public function getChannelsAsync($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getChannels'][0])
    {
        return $this->getChannelsAsyncWithHttpInfo($sort, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelsAsyncWithHttpInfo($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getChannels'][0])
    {
     ...
     */
    public function getChannelsRequest($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getChannels'][0])
    {



        if ($per_page !== null && $per_page > 50) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling ChannelsApi.getChannels, must be smaller than or equal to 50.');
        }
