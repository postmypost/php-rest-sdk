...
class RubricsApi
{
    ...
    public function getRubricsWithHttpInfo($project_id, $sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getRubrics'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Postmypost\RestSdk\Model\RubricsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Postmypost\RestSdk\Model\RubricsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Postmypost\RestSdk\Model\RubricsResponse', []),
