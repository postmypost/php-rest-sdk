...
class ProjectsApi
{
    ...
    public function getProjectsWithHttpInfo($sort = null, $page = 1, $per_page = 20, string $contentType = self::contentTypes['getProjects'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Postmypost\RestSdk\Model\ProjectsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Postmypost\RestSdk\Model\ProjectsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Postmypost\RestSdk\Model\ProjectsResponse', []),
